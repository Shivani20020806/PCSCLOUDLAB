...
@WebServlet("/getOnGoingEventsServelt")
public class GetOnGoingEventsServelt extends HttpServlet {

	private static final long serialVersionUID = -8246322412778466406L;
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			req.getRequestDispatcher("ongoing-events.jsp").forward(req, resp);
