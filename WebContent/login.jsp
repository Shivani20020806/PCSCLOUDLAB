...
<body>
    ...
    if(loginMessage !=null || message !=null){
...
<p style="color:<%= loginMessageColor %>; font-weight: bold;" ><%= loginMessage %></p>
<%
}%>
    ...
    <i class="fas fa-eye toggle-password" onclick="togglePassword()" style="position: absolute; top: 11%; right: 10px; cursor: pointer;"></i>
	
			<button class="submit-btn" type="submit">LOGIN</button>
		</form>
		<p>
			Please Note: By continuing and signing in, you agree to PCS Cloud
			Lab's <a href="#">Terms & Conditions</a> and <a href="#">Privacy
				Policy</a>.
		</p>
		<p style="text-align: center;">
			Don't have an account? <a href="#"
				onclick="window.location.href='signup.jsp'"><b>Sign Up</b></a>
		</p>
		<p style="text-align: center;">
			If Admin? <a href="#"
				onclick="window.location.href='admin.jsp'"><b>admin Login</b></a>
		</p>
	</div>
	</div>
